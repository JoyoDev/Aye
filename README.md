...
Aye is an open source tool for observing images on Kubernetes cluster. 
It uses Anchore CLI behind the scenes to get scan information about all images that are currently on the cluster.
